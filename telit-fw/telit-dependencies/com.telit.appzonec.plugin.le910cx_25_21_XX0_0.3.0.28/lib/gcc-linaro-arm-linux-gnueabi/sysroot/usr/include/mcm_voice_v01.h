...
----------  -----------    ----------   -------------------------------------
NizarKa     01-Nov-2016    Bug31776     MCM - voice call is not answered
NizarKa     28-Sep-2016    Bug31332     MCM - Update the "call_type" and "type"
Nizarka     18-Aug-2016    Bug31118     MCM Voice Indication
_____________________________________________________________________________*/
...
/**  Maximum size of call end reason text */
#define MCM_MAX_CALL_END_REASON_TEXT_V01 85
/**
    @}
  */
...
typedef enum {
  ...
  MCM_VOICE_CALL_STATE_SETUP_V01 = 0x0007, /**< Call is in Setup. */
...
typedef struct {
  ...
  char call_end_reason_text[MCM_MAX_CALL_END_REASON_TEXT_V01 + 1];
  /**<   Call end reason text.*/
  
  uint8_t call_type;
  /**<   voice data */
  
  uint8_t type;
  /**<   Call type , national international*/
