...
--------   ---     ----------------------------------------------------------
26/05/15   rh      Added new message SSIDs (ATOP)
...
/* ATOP related SSIDs*/
#define MSG_BUILD_MASK_MSG_SSID_ATOP                      (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_STDOUT               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_STDERR               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_JVM                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_NFC                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_NET                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_OSAL                 (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_AUDIO                (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_CLOCKSYNC            (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_MUXDEMUX             (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_GPS                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_GPSANI               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_GPSHAL               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_TTY                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_LOADER               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_SER                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_SERGPS               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_SERNMEA              (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_SERMUX               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_GPSBCMDIAG           (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_FOTA                 (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_TELEPHONY            (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_ECALL                (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_TLS                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_FILE                 (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_SECBOOT              (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_ROMFS                (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_GNSSTOMCU            (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_NTS                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_OTP                  (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_NC                   (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)

/* reserved for future use - if you want to add a module, please reuse these IDs first */
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA1               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA2               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA3               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA4               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA5               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA6               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA7               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA8               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA9               (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
#define MSG_BUILD_MASK_MSG_SSID_ATOP_EXTRA10              (MSG_LVL_LOW | MSG_LVL_MED | MSG_LVL_HIGH | MSG_LVL_ERROR | MSG_LVL_FATAL)
