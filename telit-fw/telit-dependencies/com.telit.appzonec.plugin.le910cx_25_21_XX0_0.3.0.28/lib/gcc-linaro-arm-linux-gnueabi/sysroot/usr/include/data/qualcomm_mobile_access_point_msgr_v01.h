...
/* This file was generated with Tool version 6.14.7
   It was generated on: Mon Apr 22 2019 (Spin 0)
...
#define QCMAP_MSGR_V01_IDL_MINOR_VERS 0x47
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define QCMAP_MSGR_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define QCMAP_MSGR_V01_MAX_MESSAGE_ID 0x00DF
/**
    @}
  */
...
typedef enum {
  ...
  QCMAP_MSGR_WLAN_MODE_P2P_ONLY_V01 = 0x0D, /**<  WLAN is in Stand-alone P2P mode  */
...
typedef struct {
  ...
  uint8_t register_backhaul_status_indication_valid;  /**< Must be set to true if register_backhaul_status_indication is being passed */
  uint8_t register_backhaul_status_indication;
  /**<   Specifies the registration. Values: \n
       - 0 -- Do not register or deregister the control point if already registered (default) \n
       - 1 -- Register for the indication; ignore if already registered
  */

  /* Optional */
  /*  Register wwan roaming status Indication */
  uint8_t register_wwan_roaming_indication_valid;  /**< Must be set to true if register_wwan_roaming_indication is being passed */
  uint8_t register_wwan_roaming_indication;
  /**<   Specifies the registration. Values: \n
       - 0 -- Do not register or deregister the control point if already registered (default) \n
       - 1 -- Register for the indication; ignore if already registered
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Identifies the WLAN mode. Values: \n
      ...
      - QCMAP_MSGR_WLAN_MODE_P2P_ONLY (0x0D) --  WLAN is in Stand-alone P2P mode
 */
...
typedef struct {
  ...
  /* Optional */
  /*  Current Backhaul IPV4 Status Indication */
  uint8_t backhaul_v4_status_valid;  /**< Must be set to true if backhaul_v4_status is being passed */
  uint8_t backhaul_v4_status;
  /**<   Indicates the backhaul IPV4 status Values: \n
       - 0 -- IPV4 Backhaul is not connected\n
       - 1 -- IPV4 Backhaul is connected
  */

  /* Optional */
  /*  Current Backhaul IPV6 Status Indication */
  uint8_t backhaul_v6_status_valid;  /**< Must be set to true if backhaul_v6_status is being passed */
  uint8_t backhaul_v6_status;
  /**<   Indicates the backhaul IPV6 status Values: \n
       - 0 -- IPV6 Backhaul is not connected\n
       - 1 -- IPV6 Backhaul is connected
  */
...
typedef struct {
  ...
  /**<   Handle identifying the mobile AP call instance.
       ...
       QMI_QCMAP_ MSGR_MOBILE_AP_ENABLE_REQ.
  */
}qcmap_msgr_get_wwan_roaming_status_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Enable or disable the role of P2P-GO or P2P-CLI */
  uint8_t p2p_status;
  ...
  /* Optional */
  /*  Identifies the Peer-to-Peer role type. */
  uint8_t p2p_role_valid;  /**< Must be set to true if p2p_role is being passed */
  qcmap_p2p_role_type_v01 p2p_role;
  /**<   Specifies the peer-to-peer role type: \n
       - QCMAP_P2P_ROLE_GO -- For peer-to-peer Group Owner \n
       - QCMAP_P2P_ROLE_CLI -- For peer-to-peer Group Client
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Current status of whether P2P is enabled or disabled */
  uint8_t p2p_status;
  ...
  /* Optional */
  /*  Current status of P2P-role i.e. whether it is P2P-GO or P2P-CLI */
  uint8_t p2p_role_valid;  /**< Must be set to true if p2p_role is being passed */
  qcmap_p2p_role_type_v01 p2p_role;
  /**<   P2P enable/disable status. Values: \n
       - QCMAP_P2P_ROLE_GO -- if role is peer-to-peer Group Owner \n
       - QCMAP_P2P_ROLE_CLI -- if role is peer-to-peer Client
   */
...
#define QMI_QCMAP_MSGR_ADD_PDN_TO_VLAN_MAPPING_REQ_V01 0x00C3
#define QMI_QCMAP_MSGR_ADD_PDN_TO_VLAN_MAPPING_RESP_V01 0x00C3
...
#define QMI_QCMAP_MSGR_GET_PMIP_MODE_REQ_V01 0x00D1
#define QMI_QCMAP_MSGR_GET_PMIP_MODE_RESP_V01 0x00D1
#define QMI_QCMAP_MSGR_SET_PMIP_MODE_REQ_V01 0x00D2
#define QMI_QCMAP_MSGR_SET_PMIP_MODE_RESP_V01 0x00D2
#define QMI_QCMAP_MSGR_GET_BACKHAUL_STATUS_REQ_V01 0x00D3
#define QMI_QCMAP_MSGR_GET_BACKHAUL_STATUS_RESP_V01 0x00D3
#define QMI_QCMAP_MSGR_BACKHAUL_STATUS_IND_V01 0x00D4
#define QMI_QCMAP_MSGR_GET_WWAN_ROAMING_STATUS_REQ_V01 0x00D5
#define QMI_QCMAP_MSGR_GET_WWAN_ROAMING_STATUS_RESP_V01 0x00D5
#define QMI_QCMAP_MSGR_WWAN_ROAMING_STATUS_IND_V01 0x00D6
#define QMI_QCMAP_MSGR_DELETE_PDN_TO_VLAN_MAPPING_REQ_V01 0x00D7
#define QMI_QCMAP_MSGR_DELETE_PDN_TO_VLAN_MAPPING_RESP_V01 0x00D7
#define QMI_QCMAP_MSGR_GET_LAN_BRIDGES_REQ_V01 0x00D8
#define QMI_QCMAP_MSGR_GET_LAN_BRIDGES_RESP_V01 0x00D8
#define QMI_QCMAP_MSGR_SELECT_LAN_BRIDGE_REQ_V01 0x00D9
#define QMI_QCMAP_MSGR_SELECT_LAN_BRIDGE_RESP_V01 0x00D9
#define QMI_QCMAP_MSGR_GET_ACTIVE_WLAN_IF_INFO_REQ_V01 0x00DA
#define QMI_QCMAP_MSGR_GET_ACTIVE_WLAN_IF_INFO_RESP_V01 0x00DA
#define QMI_QCMAP_MSGR_SET_AlWAYS_ON_WLAN_REQ_V01 0x00DB
#define QMI_QCMAP_MSGR_SET_AlWAYS_ON_WLAN_RESP_V01 0x00DB
#define QMI_QCMAP_MSGR_GET_AlWAYS_ON_WLAN_REQ_V01 0x00DC
#define QMI_QCMAP_MSGR_GET_AlWAYS_ON_WLAN_RESP_V01 0x00DC
#define QMI_QCMAP_MSGR_GET_WWAN_PROFILE_PREFERENCE_REQ_V01 0x00DD
#define QMI_QCMAP_MSGR_GET_WWAN_PROFILE_PREFERENCE_RESP_V01 0x00DD
#define QMI_QCMAP_MSGR_SET_P2P_ROLE_REQ_V01 0x00DE
#define QMI_QCMAP_MSGR_SET_P2P_ROLE_RESP_V01 0x00DE
#define QMI_QCMAP_MSGR_GET_P2P_ROLE_REQ_V01 0x00DF
#define QMI_QCMAP_MSGR_GET_P2P_ROLE_RESP_V01 0x00DF
/**
    @}
  */
