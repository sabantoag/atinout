...
/* This file was generated with Tool version 6.14.5 
   It was generated on: Tue Aug 28 2018 (Spin 0)
...
#define MCM_LOC_V01_MAX_MESSAGE_ID 0x0319
/**
    @}
  */
...
/**  Maximum number of GNSS satellites in view. */
...
/** @addtogroup mcm_loc_qmi_enums
  ...
  */
typedef enum {
  MCM_GNSS_CONSTELLATION_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  LOC_GNSS_CONSTELLATION_UNKNOWN_V01 = 0, 
  LOC_GNSS_CONSTELLATION_GPS_V01 = 1, /**<  GPS constellation.  */
  LOC_GNSS_CONSTELLATION_SBAS_V01 = 2, /**<  SBAS constellation.  */
  LOC_GNSS_CONSTELLATION_GLONASS_V01 = 3, /**<  GLONASS constellation.  */
  LOC_GNSS_CONSTELLATION_QZSS_V01 = 4, /**<  QZSS constellation.  */
  LOC_GNSS_CONSTELLATION_BEIDOU_V01 = 5, /**<  BEIDOU constellation.  */
  LOC_GNSS_CONSTELLATION_GALILEO_V01 = 6, /**<  GALILEO constellation.  */
  MCM_GNSS_CONSTELLATION_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_gnss_constellation_t_v01;
/**
    @}
  */
...
/** @addtogroup mcm_loc_qmi_enums
  ...
  */
typedef enum {
  MCM_INTERMEDIATE_REPORT_STATE_T_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  MCM_LOC_INTERMEDIATE_REPORTS_ON_V01 = 1, /**<   Intermediate reports are turned on   */
  MCM_LOC_INTERMEDIATE_REPORTS_OFF_V01 = 2, /**<   Intermediate reports are turned off   */
  MCM_INTERMEDIATE_REPORT_STATE_T_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}mcm_intermediate_report_state_t_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /* 
     ...
     * except GPS, which is reported using sv_list
      */
  LocGnssSvInfo_v01 gnss_sv_list[MCM_LOC_GNSS_MAX_SVS_CONST_V01];
}LocGnssSvStatus_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Preferred Time */
  mcm_intermediate_report_state_t_v01 intermediateReportState;
  /**<   Preferred intermediate state.*/
...
/** @addtogroup mcm_loc_qmi_messages
    @{
  */
/** Request Message; Updates the provider mode. */
typedef struct {
...
/** @addtogroup mcm_loc_qmi_messages
    @{
  */
/** Response Message; Updates the provider mode. */
typedef struct {
...
//#define REMOVE_MCM_LOC_GET_PROVIDER_V01 
...
//#define REMOVE_MCM_LOC_SET_PROVIDER_V01 
