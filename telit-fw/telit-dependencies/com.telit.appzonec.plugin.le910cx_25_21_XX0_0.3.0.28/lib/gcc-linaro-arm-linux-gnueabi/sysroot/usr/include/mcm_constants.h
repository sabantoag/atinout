...
----------  -----------     ----------   -------------------------------------
NizarKa     06-Oct-2016     Bug31646      MCM Server answers Generic Error after enabling voice+network events 
...
#define MCM_MAX_NUM_OF_ASYNC_CB 10
...
#ifdef MCM_TELIT
#define MCM_MAX_NUM_OF_MSG_ID (15)
#else
