...
/*===========================================================================
  ...
  Copyright (c) 2008-2015, 2018-2019 Qualcomm Technologies, Inc.
  All Rights Reserved
...
#if 1 //Porting from previous QCMAP version
/*===========================================================================
FUNCTION:  dsi_get_ip_addr_per_family
===========================================================================*/
/*!
    @brief
    Queries the IP address information associated with the interface per family.

    @param[in] hndl  DSI data service handle
    @param[out] info_ptr  Address information buffer
    @param[in] addr_family Family type IPv4 (0x4) and IPv6(0x6)

    @return
    DSI_ERROR - IP address query was successful 
    DSI_SUCCESS - IP address query was unsuccessful

    @dependencies
    dsi_init() must be called.
    Valid handle needs to be obtained by dsi_get_data_srvc_hndl().
*/
/*=========================================================================*/
extern int dsi_get_ip_addr_per_family
(
  dsi_hndl_t hndl,
  dsi_addr_info_t * info_ptr,
