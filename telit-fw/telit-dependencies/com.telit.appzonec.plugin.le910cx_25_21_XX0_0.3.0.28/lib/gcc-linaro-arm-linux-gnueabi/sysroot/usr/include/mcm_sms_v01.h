...
----------  -----------    ----------   -------------------------------------
NizarKa     27-Mar-2018    Bug38365     MCM - Import full SMS PDU support from CR 37508
NizarKa     20-AUG-2017    Bug35555     MCM - SMS - format field is always 6
NizarKa     05-Jul-2017    Bug34049     MCM API - MT SMS content zero if in PDU mode
NizarKa     02-Jul-2017    Bug34050     MCM API - MT SMS struct does not contain timestamp
...
#define MCM_SMS_MAX_TIMESTAMP_LENGTH_V01_V01 7

/**  Maximum string length in pdu format. */
#define MCM_PDU_MAX_LENGTH_V01 255

/**  Maximum string length of content(255) + SMSC address(11) + SMSC length(1) */
#define MCM_PDU_MT_MAX_LENGTH_V01 267
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  uint8_t mcm_sms_pdu_content_valid;  /**< Must be set to true if mcm_sms_pdu_content is being passed */
  uint32_t mcm_sms_pdu_content_len;  /**< Must be set to # of elements in mcm_sms_pdu_content */
  char mcm_sms_pdu_content[MCM_SMS_MAX_MO_MSG_LENGTH_V01];
  /**<   Message in PDU*/
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t message_content[MCM_SMS_MAX_MT_MSG_LENGTH_V01];
  /**<   Message content. */
  ...
  /* Mandatory */
  uint32_t message_content_pdu_len;  /**< Must be set to # of elements in message_content_pdu */
  char message_content_pdu[MCM_PDU_MT_MAX_LENGTH_V01];
  /**<   Message content in PDU. */
