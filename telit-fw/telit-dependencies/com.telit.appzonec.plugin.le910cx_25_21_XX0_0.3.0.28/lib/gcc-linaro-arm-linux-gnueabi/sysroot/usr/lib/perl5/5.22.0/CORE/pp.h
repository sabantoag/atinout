...
#undef SP /* Solaris 2.7 i386 has this in /jenhome/jenkins/jobs/LE910Cx_Multi_DAILY/workspace/build/apps_proc/poky/build/tmp-glibc/sysroots/mdm9607/usr/include/sys/reg.h */
#define SP sp
#define MARK mark
#define TARG targ
